...
# source: proxy/grpc/reflection/v1alpha/reflection.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='proxy/grpc/reflection/v1alpha/reflection.proto',
...
ServerReflectionRequest = _reflection.GeneratedProtocolMessageType('ServerReflectionRequest', (_message.Message,), {
  ...
  '__module__' : 'proxy.grpc.reflection.v1alpha.reflection_pb2'
